...
def draw_predAndgtOn_cart(config_data, model_cart, radar_dataset,
    ...
    save_dir = os.path.join(config_data["test_set_dir"],"RA_cart_pred_gt_0.7")
    ...
    for data, RA_cart_img, raw_boxes_cart, RAD_filename, gt_instances in radar_dataset:
        ...
        pred_raw_cart, attention_maps = model_cart(data)
        pred_cart = model_cart.decodeYolo(pred_raw_cart)
        pred_cart = pred_cart.cpu().detach().numpy()
        pred_frame_cart = pred_cart[0]
...
def get_parse():
    ...
    parser.add_argument("--resume_from", type=str,
                        default="/media/ljm/b930b01d-640a-4b09-8c3c-777d88f63e8b/Dujialun/RADDet_Pytorch-main/logs/RadarResNet/b_4lr_0.0001/ckpt/best.pth",
                        help="The number of machines.")
    parser.add_argument("--cart_resume_from", type=str,
                        default="/media/ljm/b930b01d-640a-4b09-8c3c-777d88f63e8b/Dujialun/RADDet_Pytorch-main/logs/RadarResNet/cartesian/b_4lr_0.0001/ckpt/best.pth",
                        help="The number of machines.")
