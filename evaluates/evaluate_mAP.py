...
import sys
sys.path.append('/media/sqpang/新加卷/rada_target_detection/code/RADDet_triplet_attention/')
...
def main(args, RAD_dir='RAD'):
    ...
    ### NOTE: RAD Boxes ckpt ###
    logdir = os.path.join(config_evaluate["log_dir"], config["NAME"] + "-" + config_data["input_type"] +
    ...
    output_dir = os.path.join(logdir, 'results_mAP')
    ...
    print("==========================================================")
    filename = os.path.join(output_dir, config_data["input_type"]+"-RAD Boxes AP.csv")
...
def get_parse():
    ...
    parser.add_argument("--resume_from", type=str,
                        default= "./logs/RAD-3D_head-b_12-lr_0.0001-2448/ckpt/best.pth",
                        help="The number of machines.")
    parser.add_argument("--cart_resume_from", type=str,
                        default=None,#"./logs/triplet_attention_cart_only/triplet_attention-RAD-b_24-lr_0.0001_cartesian/ckpt/epoch25_Tloss_7.4644_MAP_0.4362.pth",
                        help="The number of machines.")
